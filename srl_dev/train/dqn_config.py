...
def get_experiment_config(args, default_config):
    ...
    exp_name = f'{args.exp}/DQN_{date_time_str}'
    ...
    # default_config contains default parameter for the RL algorithm (e.g. DQN)    
    ...
    #run_configs = run_configs.training(replay_buffer_config=params_dict['replay_config'])
